            ...
            <div className="grid grid-cols-[1.2fr_320px] gap-16 relative z-10">
              ...
              <div className="space-y-5">
                ...
                <p className="text-gray-200 text-[16px] leading-relaxed max-w-xl">
                  Our advanced detection system helps you authenticate media with unprecedented accuracy, exposing manipulated content across images, videos, and audio.
                </p>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-400 text-[13px]">
                  System performance and detection tips
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-6">
              ...
              <Card className="bg-[#0f1419] border border-gray-800/50 p-6 rounded-xl">
                ...
                <div className="h-64 flex items-end justify-between gap-1">
                  {[
                    15, 22, 28, 35, 30, 38, 33, 42, 38, 45, 40, 48, 44, 52, 48, 55, 50, 58, 54, 60,
                    56, 62, 58, 65, 60, 68, 63, 70, 65, 72, 68, 75, 70, 78, 72, 80, 75, 82, 78, 85,
                    80, 88, 82, 90, 85, 92, 88, 95, 90, 98
                  ].map((height, i) => (
                    <div 
                      key={i}
                      className={`flex-1 rounded-t-sm transition-all cursor-pointer ${
                        i === 16 ? 'bg-cyan-400 shadow-lg shadow-cyan-400/50' : 'bg-cyan-600/50 hover:bg-cyan-500/70'
                      }`}
                      style={{ height: `${height}%` }}
