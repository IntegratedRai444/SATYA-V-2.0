                  ...
                  <div className="mt-4">
                    ...
                    <div className="bg-muted rounded-lg p-3">
                      <ul className="space-y-1 text-sm">
                        {result.key_findings.slice(0, 3).map((finding, findingIndex) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-green-500">
                  {history.filter(h => h.authenticity === 'AUTHENTIC MEDIA').length}
                </p>
                <p className="text-sm text-muted-foreground">Authentic</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-red-500">
                  {history.filter(h => h.authenticity === 'MANIPULATED MEDIA').length}
                </p>
