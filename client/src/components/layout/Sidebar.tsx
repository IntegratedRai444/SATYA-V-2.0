...
const Sidebar = () => {
  ...
  return (
    <aside className="w-[280px] bg-[#141414] border-r border-[#21262d] flex flex-col h-[calc(100vh-4rem)] fixed left-0 top-16 z-40">
      ...
      >
        ...
        <div className="mt-6 mb-4">
          ...
          {/* Quick Actions */}
          <div className="space-y-2">
            <button className="w-full text-left px-3 py-2 rounded-lg bg-[#1a1a1a] hover:bg-[#222222] border border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-200 group">
              <div className="flex items-center gap-2">
          ...
          {/* Open Chat Button */}
          <button className="w-full py-2.5 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-500 text-white text-[13px] font-semibold hover:shadow-lg hover:shadow-emerald-500/30 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">
            Open Chat
          </button>
        </div>
        </div>
