...
def analyze_voiceprint_consistency(
    audio_array: np.ndarray, sample_rate: int = 16000, segment_duration: float = 3.0
) -> Dict:
    """
    ...
    try:
        ...
        return {
            ...
            "suspicious_reason": "too_consistent"
            if mean_similarity > 0.95
            else "too_inconsistent"
...
class RawNet2(nn.Module):
    ...
    def __init__(self, num_classes=2):
        ...
        self.sinc_conv = nn.Conv1d(
            1, 128, kernel_size=251, stride=1, padding=125, bias=False
        )
