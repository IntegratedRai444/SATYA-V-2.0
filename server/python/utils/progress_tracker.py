...
class ProgressTracker:
    ...
    def create_task(self, task_type: str, total_steps: int = 100, 
    ...
    def update_progress(self, task_id: str, status: ProgressStatus = None,
                       progress: float = None, message: str = None,
                       details: Dict[str, Any] = None, current_step: str = None):
        """
        ...
        logger.debug(f"Progress update for {task_id}: {task['progress']*100:.1f}% - {message}")
    
    def increment_progress(self, task_id: str, increment: float = None,
    ...
    def fail_task(self, task_id: str, error_message: str, error_details: Dict[str, Any] = None):
        """
    ...
    def register_websocket(self, websocket, task_id: str = None):
        ...
        logger.info(f"WebSocket registered: {connection_id} for task: {task_id or 'all'}")
...
class ProgressContext:
    ...
    def __init__(self, task_type: str, total_steps: int = 100, 
    ...
    def increment(self, increment: float = None, message: str = None, 
...
def track_progress(task_type: str, total_steps: int = 100, 
                  metadata: Dict[str, Any] = None):
    """
...
def update_analysis_progress(task_id: str, stage: str, progress: float, 
                           details: Dict[str, Any] = None):
