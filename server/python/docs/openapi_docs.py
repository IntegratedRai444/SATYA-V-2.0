...
app = FastAPI(
    ...
    """,
    version="2.0.0",
    contact={"name": "SatyaAI Support", "email": "support@satyaai.tech"},
    ...
    openapi_tags=[
        ...
        {"name": "Image Analysis", "description": "Deepfake detection for images"},
        {"name": "Video Analysis", "description": "Deepfake detection for videos"},
        {"name": "Audio Analysis", "description": "Deepfake detection for audio files"},
...
class AnalysisRequest(BaseModel):
    ...
    model_preference: Optional[str] = Field(
        None, description="Preferred model to use for analysis"
    )
    detailed_report: bool = Field(
        False, description="Whether to include detailed analysis"
    )
...
async def analyze_image(
    ...
    detailed: bool = Query(
        False, description="Whether to include detailed analysis in the response"
    ),
):
    """
