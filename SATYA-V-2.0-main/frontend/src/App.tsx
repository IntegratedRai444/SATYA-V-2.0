...
function App() {
  ...
  useEffect(() => {
    async function fetchHealthAndConfig() {
      try {
        ...
        // Optionally show an error page or retry
        setHealth(null);
        setConfig(null);
      } finally {
        setLoading(false);
  ...
  // Optionally, check authentication here and redirect to /login if needed
  // For now, let AuthGuard handle it in protected routes
